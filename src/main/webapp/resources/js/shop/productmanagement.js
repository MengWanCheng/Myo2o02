...
$(function() {
    // 获取此店铺下的商品列表的URL
    var listUrl = '/o2o02/shopadmin/getproductlistbyshop?pageIndex=1&pageSize=999';
    // 商品下架URL
    var statusUrl = '/o2o02/shopadmin/modifyproduct';
    getList();
    /**
     * 获取此店铺下的商品列表
     * 
            ...
            .on(
                    ...
                    function(e) {
                        ...
                        if (target.hasClass('edit')) {
                            ...
                            window.location.href = '/o2o02/shopadmin/productoperation?productId='
                            ...
                            window.location.href = '/o2o02/frontend/productdetail?productId='
                                    + e.currentTarget.dataset.id;
                        }
                    });
    /**
