...
$(function() {
	...
	var infoUrl = '/o2o02/shopadmin/getproductbyid?productId=' + productId;
	// 获取当前店铺设定的商品类别列表Url
	var categoryUrl = '/o2o02/shopadmin/getproductcategorylist';
	...
	if (isEdit) {
		...
		// 编辑Url
		productPostUrl = '/o2o02/shopadmin/modifyproduct';
	} else {
		// 为false，则初始化新增product页面
		getProductInitInfo();
		// 新增Url
		productPostUrl = '/o2o02/shopadmin/addproduct';
	}
